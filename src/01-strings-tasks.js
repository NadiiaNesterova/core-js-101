...
function extractNameFromTemplate(value) {
  const startIndex = value.indexOf(' ') + 1; // Find the index of the first space and add 1 to skip it
  const endIndex = value.lastIndexOf('!'); // Find the index of the last '!' character
  return value.substring(startIndex, endIndex); // Extract the name using substring
}
