...
function angleBetweenClockHands(date) {
  ...
  const hoursAngle = (hours + minutes / 60) * 30; // каждый час = 30 градусов
  const minutesAngle = minutes * 6; // каждая минута = 6 градусов
  ...
  return (angle * Math.PI) / 180; // конвертируем в радианы
}
